...
public final class ExcelExportUtil {
     ...
     * 	          自定义导出Excel字段数组
     */
    public static Workbook exportExcel(Workbook workbookIn,ExportParams entity, Class<?> pojoClass, Collection<?> dataSet,String[] exportFields, List<ExcelExportEntity> excelParams) {
        Workbook workbook;
        if(workbookIn!=null){
            workbook=workbookIn;
        }else{
        ...
        new ExcelExportServer().appendData(workbook, entity, pojoClass, dataSet,exportFields, excelParams);
        return workbook;
    }
    ...
    public static Workbook exportExcel(ExportParams entity, Class<?> pojoClass, Collection<?> dataSet) {
        ...
        new ExcelExportServer().appendData(workbook, entity, pojoClass, dataSet,null, null);
        return workbook;
    }
    ...
    public static Workbook exportExcel(List<Map<String, Object>> list, ExcelType type) {
        ...
        for (Map<String, Object> map : list) {
            ...
            server.appendData(workbook, (ExportParams) map.get("title"), (Class<?>) map.get("entity"), (Collection<?>) map.get("data"),null, new ArrayList<>());
        }
        return workbook;
    }
